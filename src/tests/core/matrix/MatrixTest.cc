...
TEST_F(MatrixTest, MatmulMethod) {
	...
	EXPECT_EQ(A.matmul(B), expected_result);

	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> D({0.5f, 0.5f, 0.5f, 0.25f, 0.25f, 0.25f, 0.125f, 0.125f, 0.125f}, 3, 3);
	s21::Matrix<float> expected_result2({1.375f, 1.375f, 1.375f, 4.f, 4.f, 4.f, 6.625f, 6.625f, 6.625f}, 3, 3);
	EXPECT_EQ(C.matmul(D), expected_result2);
	//TODO: throws error
}
...
TEST_F(MatrixTest, MatmulTransposedMethod) {
	...
	s21::Matrix<int> expected_result({58, 64, 139, 154}, 2, 2);
	EXPECT_EQ(A.matmulTransposed(B), expected_result);

	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> D({0.5f, 0.25f, 0.125f, 0.5f, 0.25f, 0.125f, 0.5f, 0.25f, 0.125f}, 3, 3);
	s21::Matrix<float> expected_result2({1.375f, 1.375f, 1.375f, 4.f, 4.f, 4.f, 6.625f, 6.625f, 6.625f}, 3, 3);
	EXPECT_EQ(C.matmulTransposed(D), expected_result2);
	//TODO: throws error
}
TEST_F(MatrixTest, SquareMethod) {
	...
	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> expected_result2({1.0f, 4.0f, 9.0f, 16.f, 25.f, 36.f, 49.0f, 64.0f, 81.0f}, 3, 3);
...
TEST_F(MatrixTest, MultiplyScalarMethod) {
	...
	EXPECT_EQ(A.multiply_scalar(5), expected_result);

	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> expected_result2({5.0f, 10.0f, 15.0f, 20.f, 25.f, 30.f, 35.0f, 40.0f, 45.0f}, 3, 3);
	EXPECT_EQ(C.multiply_scalar(5), expected_result2);
	//TODO: throws error
}
...
TEST_F(MatrixTest, AdditionMethod) {
	...
	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> D({0.5f, 0.5f, 0.5f, 0.25f, 0.25f, 0.25f, 0.125f, 0.125f, 0.125f}, 3, 3);
	s21::Matrix<float> expected_result2({1.5f, 2.5f, 3.5f, 4.25f, 5.25f, 6.25f, 7.125f, 8.125f, 9.125f}, 3, 3);
...
TEST_F(MatrixTest, InversionOperator) {
	...
	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> expected_result2({-1.0f, -2.0f, -3.0f, -4.0f, -5.0f, -6.0f, -7.0f, -8.0f, -9.0f}, 3, 3);
...
TEST_F(MatrixTest, SubstractionOperator) {
	...
	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> D({0.5f, 0.5f, 0.5f, 0.25f, 0.25f, 0.25f, 0.125f, 0.125f, 0.125f}, 3, 3);
	s21::Matrix<float> expected_result2({0.5f, 1.5f, 2.5f, 3.75f, 4.75f, 5.75f, 6.875f, 7.875f, 8.875f}, 3, 3);
	EXPECT_EQ(C - D, expected_result2);
	//TODO: throws error
}
//TODO: transpose test
TEST_F(MatrixTest, TransposingOperator) {
	...
	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> expected_result2({1.0f, 4.0f, 7.f, 2.f, 5.f, 8.f, 3.f, 6.f, 9.f}, 3, 3);
...
TEST_F(MatrixTest, ApplyFunctionMethod) {
	...
	EXPECT_EQ(A.apply_function([](const int &n) -> int { return n % 2 == 0; }), expected_result);

	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	s21::Matrix<float> expected_result2({0.0f, 1.0f, 0.f, 1.f, 0.f, 1.f, 0.f, 1.f, 0.f}, 3, 3);
	EXPECT_EQ(C.apply_function([](const float &n) -> float { return (int) n % 2 == 0; }), expected_result2);
}
//TODO: ToVector test
TEST_F(MatrixTest, ToVectorMethod) {
	...
	s21::Matrix<float> C({1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, 3, 3);
	std::vector<float> expected_result2 ={1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f};
