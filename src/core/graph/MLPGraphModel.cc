...
const ActivationFunction &MLPGraphModel::get_af() const { return af; }

void MLPGraphModel::set_af(ActivationFunction &af) { MLPGraphModel::af = af; }

float MLPGraphModel::get_start_lr() const { return start_lr; }

void MLPGraphModel::set_start_lr(float startLr) { start_lr = startLr; }

float MLPGraphModel::get_lr() const { return lr; }

void MLPGraphModel::set_lr(float lr) { MLPGraphModel::lr = lr; }
