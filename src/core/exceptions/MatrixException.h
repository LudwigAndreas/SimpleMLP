#ifndef SIMPLEMLP_MATRIXEXCEPTION_HPP
#define SIMPLEMLP_MATRIXEXCEPTION_HPP
...
{
public:
	explicit MatrixCalculationsException(const char* message)
			: msg_(message) {}

	explicit MatrixCalculationsException(std::string& message)
	: msg_(message) {}
...
#endif //SIMPLEMLP_MATRIXEXCEPTION_HPP
