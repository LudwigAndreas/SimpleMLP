...
#ifndef SIMPLEMLP_LETTERRECOGNITIONMLPMODELBUILDER_H
#define SIMPLEMLP_LETTERRECOGNITIONMLPMODELBUILDER_H
...
#endif  // SIMPLEMLP_LETTERRECOGNITIONMLPMODELBUILDER_H
